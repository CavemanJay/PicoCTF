...
class VaultDoor8Tampered {
    public static void main(String args[]) {
        ...
        VaultDoor8Tampered a = new VaultDoor8Tampered();
    ...
    public char switchBits(char c, int p1, int p2) {
        ...
        byte byte1 = (byte) mask1;
        char mask2 = (char) (1 << p2);
        byte byte2 = (byte) mask2;
        /* char mask3 = (char)(1<<p1<<p2); mask1++; mask1--; */ 
        char bit1 = (char) (c & mask1);
        char bit2 = (char) (c & mask2);
        byte byte3 = (byte) bit2;
        /*
    ...
    public boolean checkPassword(String password) {
        ...
        char[] flag_chars = unscramble(expected);
        var flag = "picoCTF{" + String.valueOf(flag_chars) + "}";
